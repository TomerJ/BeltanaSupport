...
class Menu(commands.Cog):
    """Manages the menu prior to a ticket being created"""
    ...
    async def on_thread_ready(self, thread, creator, category, initial_message):
        """Sends out menu to user"""
            ...
            thread.reply("""
            Thanks for contacting us! Please select a category by reacting to this message.
            
            1️⃣ I didn't get an item which I bought using robux
            2️⃣ I can't get into Beltana
            3️⃣ Bug Reports
            4️⃣ Beltana ATC
            5️⃣ Moderation
            """)
